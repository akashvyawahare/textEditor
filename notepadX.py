...
main_application.title('NotepadX Text Editor')
...
# view_menu(View) menu icons
tool_bar_icon = tk.PhotoImage(file='icons2/tool_bar.png')
status_bar_icon = tk.PhotoImage(file='icons2/status_bar.png')

#color theme menu (color_theme_menu)icons
light_default_icon = tk.PhotoImage(file='icons2/light_default.png')
light_plus_icon = tk.PhotoImage(file='icons2/light_plus.png')
dark_icon = tk.PhotoImage(file='icons2/dark.png')
red_icon = tk.PhotoImage(file='icons2/red.png')
monokai_icon = tk.PhotoImage(file='icons2/monokai.png')
nightblue_icon = tk.PhotoImage(file='icons2/night_blue.png')

def func():
    pass

#creating submenus(which lies inside main menu)
file_menu = tk.Menu(main_menu,tearoff=0)
edit_menu = tk.Menu(main_menu,tearoff=0)
view_menu = tk.Menu(main_menu,tearoff=0)
color_theme_menu = tk.Menu(main_menu,tearoff=0)

#adding cascade(add_cascade)
...
# adding contents in the Color Theme menu(color_theme_menu)
...
# bold, italic, undelined icons and buttons
...
# align left/right/center icons and buttons 
...
# font family and font size functionnality
...
def changed(event=None):
    ...
    #    characters = len(text_editor.get(1.0, 'end-1c').replace(' ', '')) #if you dont want to count spaces
...
# file_menu commands
#adding contents in the submenu(File)(using add_command)
...
#find functionality in Edit menu(designing its window also)
...
# edit_menu commands
#adding contents in the submenu(Edit) using add command
...
# view/hide toolbar statusbar functionality
...
#adding contents in the View submenu
view_menu.add_checkbutton(label='Tool Bar',onvalue=True,offvalue=False,variable=show_toolbar, image=tool_bar_icon, command=hide_toolbar, compound=tk.LEFT)
view_menu.add_checkbutton(label='Status Bar',onvalue=1,offvalue=0,variable=show_statusbar, image=status_bar_icon, command=hide_statusbar, compound=tk.LEFT)

# color_theme_menu commands
def change_theme():
